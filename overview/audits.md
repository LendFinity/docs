...
Lendfinity is a dynamic lending protocol that closely resembles Aave V3. It was developed as a fork from the original Aave protocol. As a result, Lendfinity inherits the battle-tested and audited smart contract codebase from Aave V3.

### Existing Audits from Aave <a href="#existing-audits-from-aave" id="existing-audits-from-aave"></a>

By leveraging the well-established codebase of Aave V3, LendFinity can focus on delivering a seamless and user-friendly experience while upholding the highest standards of safety in the DeFi space.
